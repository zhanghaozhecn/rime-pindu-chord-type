...
### 二分原理
大部分字取部首时需要用到二分原理。二分原理的主旨是直观，以二分后的部件组字能力强为主，结构清晰为辅，能二分尽量二分。例：**族→𭤨矢**。针对二分边界不明确，或只能认定为三部分的字/部件，放弃中间部件，将前后部件认定为二分后的部件。例：**嬲→男男**，**掰→手手**，**彝→彐艹**，**真→十八**，**克→十儿**。

### 形声字
特指明显的形声字，即声旁与字的读音相似（清晴青，努弩奴），或者声旁相同的两个以上字的读音相似（稳隐相似但和急不相似，活括话相似但和舌不相似），相似指部分相似，如声母分别为j/zh、n/r等也认为相似，只有完全看不出的形声字才会排除。

如果**形旁是部首**，取形旁作为部首。例：**势→力**，**堂→土**。

如果**形旁不是部首**，将形旁二分。对任何形旁都**优先取多笔部首**，没有多笔部首时才取单笔部首。
1. 按照笔画顺序，在切分出的2个部件中找部首，例：**将→夕**（声旁在左，取右上“夕”，不取右下“寸”），**懿→心**（声旁在左，右上“次”非部首，取右下“心”），**毙→歹**（声旁在上，取左下“歹”，不取右下“匕”），**截→十**（声旁在左下，取“十”，不取“戈”），**雁→隹**（声旁在左上，取“亻”，不取“隹”）。
1. 形旁不能二分或二分后部件都不是部首，将形旁按“非形声字-不能二分”处理。例：**疍→卜**（声旁在下，形旁“疋”是一个部分，按有一个部分取“卜”），**孵→卩**（声旁在右，形旁“卵”二分后都不是部首，按有一个部分取“卩”）。

### 非形声字
特指除部首字和明显的形声字之外的字，即会意字、指事字、象形字和声旁字形变化、声旁和字的读音不像、声旁不会读的形声字。对非形声字进行分区，两分优先。对任何字都**优先取多笔部首**，没有多笔部首时才取单笔部首，按不能二分处理。
...
1. 按照笔画顺序，在切分出的3~4个部分中取部首，例：**蠲→皿**（左上不是部首，左下是部首），**巢→日**（上半不能二分，下半二分为日木，取“日”），**睾→罒**（上半二分为丶罒，取“罒”），**厾→土**（左下二分为土厶，取“土”），**举→⺌**（上半三分，转化为二分⺌八，取“⺌”）。
1. A和B都不能二分或二分后部件都不是部首，将整字按不能二分处理。例：**临→囗**（四个部分都不是部首，转有一个部分，取唯一的部首“囗”）。
