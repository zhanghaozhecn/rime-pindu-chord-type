...
例如：要→yao4→i+ao4→DKL'\_或DKL_，式→shi4→shi+#4→SJ';。
...
例如：记→ji4+讠→AJ'P，计→ji4+讠→AJ'P';，剂→ji4+刂→AJ'F。

# 词的打法
本方案使用大词库，可以自动调节词语候选位置，并根据历史上屏字词生成新词语，最多7字，建议用户按照自然分词输入。
