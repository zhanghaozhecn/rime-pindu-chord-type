...
## 提取部首
形旁部首码是一种只取一码的音码辅助码，设计的目的是使两音一形的选重率最低，主要手段是优先使用形旁，剔除形码中和音码重复的信息（即声旁）。本方案中部首被映射到声介和11个无理码上，部首共有180个，见键位映射一节，其中部分部首有附属字形如下。

卜⺊|竹|歹歺|母毌毋|虍虎|彐彑|子孑|老耂|聿肀|牛牜|木朩|攵攴|羊𦍌|人入|水氺|罒四|尢兀|覀西|卩㔾|乛乙|己已巳|厂𠂆|日曰|爪爫|手龵|⺌𭕄|
