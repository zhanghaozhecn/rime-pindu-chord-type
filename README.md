...
# 字形元素
## 提取部首
辅助码部分使用本人发明的“形旁部首码”，只取一个部首，设计的目的是使两音一形的单字选重率最低。主要方法是优先使用形旁，剔除形码中和字音重复的信息（声旁）。本方案中部首被映射到声介和11个无理键位上，共有180个，部首列表见键位映射一节，其中部分部首有附属字形：
...
### 非形声字
特指除部首字和明显的形声字之外的字。尽可能对非形声字进行“二分”，二分总体原则是直观，以二分后的部件组字能力强为主，结构清晰为辅。例如，毂彀觳|嫠漦釐|嬴赢蠃|族旅旋|颍颖颎|糜磨靡|螣腾縢|倏修翛|辨辫辩|衰亵褒|斡翰乾|寝寤寐，这几组字都是按照部件组字能力二分。针对二分边界不明确，或只能认定为三部分的字，舍弃中间部分，将前、后部分认定为二分结果。例：**嬲→男男**，**掰→手手**，**彝→彐廾**，**真→十八**，**克→十儿**。
...
#### 不能二分
按照**笔画顺序**取部首。例：**事→口**，**书→乛**（找不到部首，最后取单笔画）。

## 键位映射
大部分部首用其读音的声介表示，见**表-左手声介部首**。

为了减少重码，把11个部首放在右手单键上，其位置见**表-右手无理部首**。

**左手声介部首**
| 声介 | 部首                   | 声介 | 部首               | 声介 | 部首                       |
|------|------------------------|------|--------------------|------|----------------------------|
| #    | 儿耳二阝               | tu   | 土                 | xi   | ⺌夕覀香小㣺心辛行         |
| i    | 牙言羊业页衤衣音尢酉又 | ni   | 鸟牛               | xv   | 彐穴血                     |
| u    | 瓦王韦文               | nv   | 女                 | zh   | 乛支止豸舟                 |
| v    | 鱼羽雨玉聿             | l    | 老耒               | zhu  | 爪竹隹                     |
| b    | 八丷白勹贝卜不         | li   | 力立               | ch   | 厂车齿彳赤                 |
| bi   | 鼻匕髟疒冫             | lu   | 龙鹿               | chu  | 虫                         |
| p    | 攵夊                   | g    | 宀戈革鬲           | sh   | 彡舌身尸十饣食矢豕士礻示手 |
| pi   | 皮片丿                 | gu   | 工弓廾谷骨瓜广鬼   | shu  | 殳鼠丨水                   |
| m    | 马毛矛门母目           | k    | 口                 | r    | 人日肉                     |
| mi   | 米皿冖                 | ku   | 匚凵冂囗           | z    | 廴子辶走                   |
| f    | 方非风缶父             | h    | 禾黑一             | zu   | 足                         |
| d    | ⺈刂大歹刀斗豆         | hu   | 虍户火灬           | c    | 艹                         |
| di   | 丶                     | ji   | 卩几己见角巾斤金臼 | cu   | 寸                         |
| t    | 亠                     | qi   | 气欠               | s    | 糸三厶罒                   |
| ti   | 田                     | qv   | 犭犬               |      |                            |
